    ...
    function render(data, params) {
      ...
      function getURL1(dict) {
        ...
        for (let [key, value] of Object.entries(dict)) {
          ...
          var storageRef = firebase.storage().ref("images/");
          storageRef.child(value.substring(0, 9)+".jpg").getDownloadURL().then(function(url) {
      ...
      function getURL2(dict) {
        ...
        for (let [key, value] of Object.entries(dict)) {
          ...
          var storageRef2 = firebase.storage().ref("annotation/"+value.substring(0, 9));
      ...
      function runSystem(dict) {
        ...
        for (var i = 1; i < list_image.length; i++) {
          ...
          // document.getElementById('lc').innerHTML += "<br>";
